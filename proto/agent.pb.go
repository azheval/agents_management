...
const file_proto_agent_proto_rawDesc = "" +
	...
	"\x10SubmitTaskResult\x12).agent_management.SubmitTaskResultRequest\x1a*.agent_management.SubmitTaskResultResponseB\x1aZ\x18agent-management/pkg/apib\x06proto3"
