...
const file_proto_agent_proto_rawDesc = "" +
	...
	"\x10SubmitTaskResult\x12).agent_management.SubmitTaskResultRequest\x1a*.agent_management.SubmitTaskResultResponseB8Z6github.com/agent-management/agent-management/agent/apib\x06proto3"
